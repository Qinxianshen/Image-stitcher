...
color_image, H_matrix,val_image,four_points_array,four_points = get_test("./test_images2/*.jpg")
...
M = cv2.estimateRigidTransform(rectangle_image,warped_image,True)
print(M)
H_new = np.row_stack((M,[0,0,1]))
print(H_new)
